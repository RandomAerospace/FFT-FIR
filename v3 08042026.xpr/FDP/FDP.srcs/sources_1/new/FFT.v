...
module visual_fft_bridge(
    ...
    // 1. Decimation & Collection Buffer
    ...
    //The write_ptr (0 to 1023) perfectly matches the position in the 1024-point window
    ...
    // 2. Burst Control State Machine (so that we collect the 1024 samples, then burst into SPIRAL FFT core
...
module fft_processor (
    ...
    // --- 1. Magnitude Approximation (Alpha Max + Beta Min) ---
    ...
    // --- 2. Capture Control (512 bins = 256 cycles) ---
    reg [7:0] write_ptr = 0; 
    reg processing = 0;
    reg data_active = 0;
    ...
    // --- 4. SCROLLING MAPPING LOGIC ---
    // Instead of (oled_x * 4), we use a sliding window
    ...
    always @(*) begin
        ...
        localparam NOISE_THRESHOLD = 12'd60; 
...
module seven_seg_driver (
    ...
    // --- 3. Digit Decoding and Display Logic ---
    always @(*) begin
        case (digit_select)
            2'b00: begin
